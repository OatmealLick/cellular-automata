...
public class Automaton2DimTest {
    ...
    public void correctlyReturningInfoAboutEndOfBoard() {
        ...
        ), new UniformStateFactory(BinaryState.ALIVE), height, width, false, "23/3");
    ...
    public void correctlyReturningInfoAboutFactThatThereAreCoordsToGoThrough() {
        Automaton2Dim automaton2Dim = new GameOfLife(null, new UniformStateFactory(BinaryState.ALIVE), height, width,
                false, "23/3");
    ...
    public void nextCoordinatesTake1() {
        ...
        Automaton2Dim automaton2Dim = new GameOfLife(null, new UniformStateFactory(BinaryState.ALIVE),
                height, width, false, "23/3");
    ...
    public void nextCoordinatesTake2() {
        Automaton2Dim automaton2Dim = new GameOfLife(new MoorNeighbourhood(
                100, height, 1, false
        ), new UniformStateFactory(BinaryState.ALIVE), height, 100, false, "23/3");
